...
NB:  development has for now moved to the `patchDVI` project. 
These instructions have been updated to reflect that change, but
the actual code in this repository has not!
